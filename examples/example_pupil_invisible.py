"""
In this example, we will load the data from the Pupil Invisible and extract gaze behavior from the data.
"""

import os

from eyedentify3d import PupilInvisibleData, TimeRange, ErrorType, GazeBehaviorIdentifier
