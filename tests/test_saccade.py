...
def test_set_eye_angular_velocity(mock_compute_angular_velocity, mock_data_object):
    ...
    mock_compute_angular_velocity.assert_called_once_with(
        mock_data.time_vector, mock_data.eye_direction
    )
...
def test_initialize(mock_data_object):
    ...
    with patch.object(event, 'set_eye_angular_velocity') as mock_set_velocity, \
